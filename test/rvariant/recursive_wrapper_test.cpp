...
{
    {
        iris::recursive_wrapper<int> a(33), b(4);
    ...
    {
        int a = 33;
        iris::recursive_wrapper<int> b(4);
...
TEST_CASE("implicit conversion (int/double)", "[wrapper]")
{
    ...
    using RW_double = iris::recursive_wrapper<double>;
    ...
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<RW_int>, double>);
    STATIC_REQUIRE(!std::is_constructible_v<iris::rvariant<RW_int>, RW_double>); // banned for Literal<int, double> to be distinguishable in ASTs
    ...
    // ----------------------------------------------
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<RW_double>, RW_double>);
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<RW_double>, int>);
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<RW_double>, double>);
    STATIC_REQUIRE(!std::is_constructible_v<iris::rvariant<RW_double>, RW_int>); // banned for Literal<int, double> to be distinguishable in ASTs
    STATIC_REQUIRE(!std::is_constructible_v<iris::rvariant<RW_double>, NonExistent>);
    ...
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<int, double>, int>);
    STATIC_REQUIRE(                         iris::rvariant<int, double>{42}.index() == 0);

    STATIC_REQUIRE( std::is_constructible_v<std::variant<RW_int, double>, int>);
    STATIC_REQUIRE(                         std::variant<RW_int, double>{42}.index() == 0);
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<RW_int, double>, int>);
    STATIC_REQUIRE(                         iris::rvariant<RW_int, double>{42}.index() == 0);

    STATIC_REQUIRE( std::is_constructible_v<std::variant<int, RW_double>, int>);
    STATIC_REQUIRE(                         std::variant<int, RW_double>{42}.index() == 0);
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<int, RW_double>, int>);
    STATIC_REQUIRE(                         iris::rvariant<int, RW_double>{42}.index() == 0);

    STATIC_REQUIRE(!std::is_constructible_v<std::variant<RW_int, RW_double>, int>); // banned; equally viable
    STATIC_REQUIRE(!std::is_constructible_v<iris::rvariant<RW_int, RW_double>, int>); // banned; equally viable

    // (int|double) = double
    STATIC_REQUIRE( std::is_constructible_v<std::variant<int, double>, double>);
    STATIC_REQUIRE(                         std::variant<int, double>{3.14}.index() == 1);
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<int, double>, double>);
    STATIC_REQUIRE(                         iris::rvariant<int, double>{3.14}.index() == 1);
    ...
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<RW_int, double>, double>);
    STATIC_REQUIRE(                         iris::rvariant<RW_int, double>{3.14}.index() == 1);
    ...
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<int, RW_double>, double>);
    STATIC_REQUIRE(                         iris::rvariant<int, RW_double>{3.14}.index() == 1);

    STATIC_REQUIRE(!std::is_constructible_v<std::variant<RW_int, RW_double>, double>); // banned; equally viable
    STATIC_REQUIRE(!std::is_constructible_v<iris::rvariant<RW_int, RW_double>, double>); // banned; equally viable

    // (int|double) = float
    STATIC_REQUIRE( std::is_constructible_v<std::variant<int, double>, float>);
    STATIC_REQUIRE(                         std::variant<int, double>{3.14f}.index() == 1);
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<int, double>, float>);
    STATIC_REQUIRE(                         iris::rvariant<int, double>{3.14f}.index() == 1);
    ...
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<RW_int, double>, float>);
    STATIC_REQUIRE(                         iris::rvariant<RW_int, double>{3.14f}.index() == 1);
    ...
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<int, RW_double>, float>);
    STATIC_REQUIRE(                         iris::rvariant<int, RW_double>{3.14f}.index() == 1);

    STATIC_REQUIRE(!std::is_constructible_v<std::variant<RW_int, RW_double>, float>); // banned; equally viable
    STATIC_REQUIRE(!std::is_constructible_v<iris::rvariant<RW_int, RW_double>, float>); // banned; equally viable
}

TEST_CASE("implicit conversion (string)", "[wrapper]")
{
    struct NonExistent {};
    using RW_string = iris::recursive_wrapper<std::string>;
    using RW_string_view = iris::recursive_wrapper<std::string_view>;
    ...
    // ----------------------------------------------
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<RW_string>, RW_string>);
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<RW_string>, std::string>);
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<RW_string>, char const*>);
    STATIC_REQUIRE(!std::is_constructible_v<iris::rvariant<RW_string>, std::string_view>); // banned; requires explicit constructor
    STATIC_REQUIRE(!std::is_constructible_v<iris::rvariant<RW_string>, NonExistent>);
}
...
TEST_CASE("implicit conversion + flexible (int/double)", "[wrapper][flexible]")
{
    ...
    // ----------------------------------------------
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<RW_int>, iris::rvariant<RW_int>>);
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<RW_int>, iris::rvariant<int>>);       // flexible constructor
    STATIC_REQUIRE(!std::is_constructible_v<iris::rvariant<RW_int>, iris::rvariant<double>>);    // banned for Literal<int, double> to be distinguishable in ASTs
    STATIC_REQUIRE(!std::is_constructible_v<iris::rvariant<RW_int>, iris::rvariant<RW_double>>); // banned for Literal<int, double> to be distinguishable in ASTs
    ...
    // ----------------------------------------------
    STATIC_REQUIRE(!std::is_constructible_v<iris::rvariant<RW_double>, iris::rvariant<RW_int>>);    // banned for Literal<int, double> to be distinguishable in ASTs
    STATIC_REQUIRE(!std::is_constructible_v<iris::rvariant<RW_double>, iris::rvariant<int>>);       // banned for Literal<int, double> to be distinguishable in ASTs
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<RW_double>, iris::rvariant<double>>);    // flexible constructor
    STATIC_REQUIRE( std::is_constructible_v<iris::rvariant<RW_double>, iris::rvariant<RW_double>>);
